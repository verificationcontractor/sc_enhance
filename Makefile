...
test_sc_process_wrapper2:
	g++ -std=c++17 -o tests/test_sc_process_wrapper2 -I include -lsystemc tests/test_sc_process_wrapper2.cpp
...
build_tests: test_connect_ports test_constructors test_sc_fork test_sc_process_wrapper test_sc_process_wrapper2 test_sc_repeat test_sc_loopfork_join
